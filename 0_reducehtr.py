...
if ((exmode=='extract') or (exmode=='go')):
...
if ((exmode=='stksds') or (exmode=='go')):
	print("\n[Step 3] Constructing dynamic spectra for I, Q, U, V with {} channels...\n".format(nchan))
	natresms	=	gen_stokes_ds(frbname, frbdm, nchan)
...
if ((exmode=='genoise') or (exmode=='go')):
...
if ((exmode=='badchan') or (exmode=='go')):
